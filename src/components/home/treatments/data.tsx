...
const data: TreatmentData[] = [
  ...
  },
  {
    id: 2,
    img: img.treatments2,
    imgSmall: img.treatments2small,
    title: "Energy Booster",
    navText: ["Energy", "Booster"],
    description: [
  ...
  },
  {
    id: 4,
    img: img.treatments4,
    imgSmall: img.treatments4small,
    title: "Facial Definition",
    navText: ["Facial", "Definition"],
    description: [
  ...
  },
  {
    id: 5,
    img: img.treatments5,
    imgSmall: img.treatments5small,
    title: "Facial Smoother",
    navText: ["Facial", "Smoother"],
    description: [
  ...
  },
  {
    id: 6,
    img: img.treatments6,
    imgSmall: img.treatments6small,
    title: "Anti-Wrinkle",
    navText: ["Anti-Wrinkle"],
    description: [
  ...
  },
  {
    id: 7,
    img: img.treatments7,
    imgSmall: img.treatments7small,
    title: "Skin Boosters",
    navText: ["Skin Boosters"],
    description: [
  ...
  },
  {
    id: 8,
    img: img.treatments8,
    imgSmall: img.treatments8small,
    title: "Body Definition",
    navText: ["Body", "Definition"],
    description: [
  ...
  },
  {
    id: 9,
    img: img.treatments9,
    imgSmall: img.treatments9small,
    title: "Non-Surgical BBL + Hip Filler",
    navText: ["Non-Surgical", "BBL + Hip", "Filler"],
    description: [
